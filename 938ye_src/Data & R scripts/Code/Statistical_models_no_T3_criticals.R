...
# This version was created in June 2018 and last modified by Eva Koch in April 2022.
...
# Further, only critical items are included in the present model, not control items.

# Libraries
library(lme4); library(tictoc); library(arm); library(MuMIn)
...
# Obtain F-test output (Type III of fixed effects)
library(afex)
afex::set_sum_contrasts() # sets sum coding globally
car::Anova(final, type = 3)
